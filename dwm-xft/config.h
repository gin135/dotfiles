...
/* appearance */
static const char font[]            = "Migu 1M:pixelsize=16,style=regular"; // Xft
// static const char font[]            = "VL Gothic:pixelsize=15,style=regular"; // Xft
// static const char font[]            = "-*-VL Gothic-medium-*-*-*-15-*-*-*-*-*-*-*"; // XLFD
// static const char font[]            = "-*-Ricty-medium-*-*-*-14-*-*-*-*-*-*-*"; // XLFD
...
static const Rule rules[] = {
	...
	{ "Clementine",  NULL,       NULL,       1 << 4,       False,        1 },
...
static const char *dmenucmd[] = { "dmenu_run", "-fn", font, "-p", prompt, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };

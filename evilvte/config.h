...
#define MENU_MATCH_STRING_EXEC "chromium"
...
#define MENU_CUSTOM            "Select all", "Separator", "Copy", "Paste", "Separator", "Zoom in", "Zoom out", "Zoom default", "Separator", "Select font", "Toggle scrollbar", "Toggle status bar", "Toggle fullscreen", "Toggle always on top", "Adjust saturation", "Separator", "Reset terminal", "Separator", "Quit"
